...
public class TestMultiThread {
    ...
    public static void main(String[] args) {
        ...
        Worker worker0 = new Worker("c", countDownLatch); // c
        Worker worker1 = new Worker("d", countDownLatch); // d
        Worker worker2 = new Worker("e", countDownLatch); // e
        Worker worker3 = new Worker("f", countDownLatch); // f

        try {
            Object object0 = worker0.call();
            Object object1 = worker1.call();
            Object object2 = worker2.call();
            Object object3 = worker3.call();
            countDownLatch.await(); // 等待所有磁盘计算完毕

            int total = (int) object0 + (int) object1 + (int) object2 + (int) object3;
